                                    ...
                                    <tr key={idx} className="border-bottom">
                                        ...
                                        <td className="py-4">
                                            <div className="d-flex flex-column gap-2 px-3">
                                                 <button className="btn btn-sm btn-outline-secondary rounded-pill shadow-sm" style={{ fontSize: '0.7rem' }}>
                                                    Detail
                                                </button>
                                                <button className="btn btn-sm btn-primary rounded-pill shadow-sm border-0 fw-medium" style={{ fontSize: '0.7rem', backgroundColor: '#4318FF' }}>
                                                    Submit ERP
                                                </button>
                                            </div>
                                        </td>
