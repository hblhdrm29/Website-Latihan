...
export default function KonfirmasiSPBEKeluar() {
    return (
        <div className="container-fluid p-0">
             <div className="d-flex align-items-center gap-3 mb-4">
                <h3 className="fw-bold mb-0" style={{ color: '#20288E' }}>Konfirmasi SPBE Keluar</h3>
            </div>
            
            {/* Filter Section - Mirrored from PermohonanSPBEView */}
